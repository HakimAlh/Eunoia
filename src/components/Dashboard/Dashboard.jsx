    ...
    <>
              <section className={styles.about}>
                        <header>
                          ...
                          <Link style={{fontSize: '50px', color: 'white'}} to="/books/67e44194ede0c59181f2a656">Enigma X!</Link>
        ...
        <main className={styles.container}>
          {props.books.map((book) => (
            <Link key={book._id} to={`/books/${book._id}`}>
              <article>
                <header>
                  <img style={{ height: '180px', width: '130px', border: 'solid 1px'}} src={book.cover} alt="" />
                  <h2>{book.title}</h2>
